...
if __name__ == '__main__':
    ...
    recovery_percentages_with_capping = recovery_percentage_coupling_rate(coupling_rates=coupling_rates, strand_length=strand_length, repeats=repeats, simulations=simulations, capping=True)
    ...
    plt.title(f'Recovery Percentage vs Coupling Rate with {repeats} repeats, for strand length {strand_length}', fontsize=14)
