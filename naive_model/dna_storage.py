...
class NaiveDNAStorageModel:
    ...
    def __init__(self, coupling_rate, strand_length, repeats,
                  insertion_probatility=0.04, deletion_probability=0.1, subsitution_probability=0.15,
                  capping=True):
    ...
    def simulate_storage(self):
        ...
        consensus_strand = self.sequencing_model.consensus_decoding(sequenced_strands, self.strand, alignment=True)
